...
function Attorneys() {
  return (
    <section id='attorneys' className='w-full h-full items-center'>
        <div className='justify-self-center text-center md:mt-24 pt-5 m-5'>
            <h1 className='text-4xl mb-5 md:text-6xl mt-5 md:mt-5 text-yellow-500'> Our Attorneys </h1>
            <p className='text-sm md:text-xl md:ml-10 md:mr-10 text-slate-600'>
            ...
            <h1 className='text-3xl mb-5 md:text-4xl md:mt-5 text-yellow-500'>Why choose Us</h1>
            <ol className='text-sm md:text-2xl text-slate-600'>
  <li className='flex items-center'>
    <div>
      <p className='text-md md:text-xl font-semibold text-gray-400'>Best Law Practices</p>
  ...
  <li className='flex items-center mt-5'>
    <div>
      <p className='text-md md:text-xl font-semibold text-gray-400'>Efficiency & Trust</p>
      <p className='text-md md:text-lg'>
  ...
  <li className='flex items-center mt-5'>
    <div>
      <p className='text-md md:text-xl font-semibold text-gray-400'>Results You Deserve</p>
      <p className='text-md md:text-lg'>
        Achieving the best possible outcomes for our clients with proven results.
            ...
            <div className='w-full items-center justify-center grid md:mt-10'> <Image src={feature} width={350} />
