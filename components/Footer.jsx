...
function Footer () {
    ...
    <div className="mr-12 hidden lg:block">
      <p className="text-yellow-500 xl:text-xl">Stay in contact with us:</p>
    </div>
  ...
  <div className="mx-6 py-6 text-center md:text-left">
    <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-3">
      <div className="">
        <h6 className="mb-4 xl:text-xl flex items-center justify-center font-semibold md:justify-start text-yellow-500"> Your Company Name
        </h6>
        <p className="md:w-56 text-white xl:text-xl">
        At [Your Company Name], we believe in justice for all and are passionate about advocating for our clients' rights.
        </p>
      </div>
      <div className="text-white">
        <h6 className="mb-3 xl:text-xl flex justify-center font-semibold md:justify-start text-yellow-500">
          Useful links
        </h6>
        <p className="mb-3">
          <Link href="/#home" className="xl:text-xl">Home</Link>
        </p>
        <p className="mb-3">
          <Link href="/#services" className="xl:text-xl">Services</Link>
        </p>
        <p className="mb-3">
          <Link href="/#attorneys" className="xl:text-xl">Attorneys</Link>
        </p>
        <p className="mb-3">
      ...
      <div className="text-white">
        <h6 className="mb-4 xl:text-xl flex justify-center font-semibold md:justify-start text-yellow-500"> Contact
        </h6>
        <p className="mb-4 xl:text-xl flex items-center justify-center md:justify-start">
        1234 1st Ave<br/>Seattle, WA 98101
        </p>
        <p className="mb-4 xl:text-xl flex items-center justify-center md:justify-start"> + 206 777 8888
        </p>
        <p className="flex xl:text-xl items-center justify-center md:justify-start"> + 206 555 3333
        </p>
      </div>
    </div>
  </div>
  <hr className="w-1/2 mx-auto h-0.5 bg-white"></hr>
      <div className="bg-gradient-to-r from-slate-400 to-slate-600 pt-2 pb-2 text-center xl:text-lg text-yellow-500"> © 2023 Copyright: Bartosz Jarzyło
      </div>
</footer>
  );
};
