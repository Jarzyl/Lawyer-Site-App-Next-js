...
function Testimonial() {
  return (
    <section id='testimonial' className='w-full md:h-screen pt-5 items-center'>
        <div className='text-white mt-12'>
        <h1 className='text-4xl mb-8 md:mb-16 md:text-6xl text-center text-yellow-500'> Testimonials </h1>
        <div className='justify-center grid md:flex gap-5 mt-5 mr-10 ml-10'>
        <div className='items-center border-4 border-solid h-64 w-60 bg-gradient-to-r from-slate-400 to-slate-600'>
        <p className='mt-2 mb-2 text-center text-yellow-500'> Anna </p>
        <Image src={op} width={150} alt='' className='mx-auto w-20 h-20 rounded-full'/>
        <h1 className='text-xs m-6  mt-2'>
        ...
        <div className='items-center  border-4 border-solid h-64 w-60 bg-gradient-to-r from-slate-400 to-slate-600'>
        <p className='mt-2 mb-2 text-center text-yellow-500'> Mark </p>
        ...
        <div className='items-center  border-4 border-solid h-64 w-60 bg-gradient-to-r from-slate-400 to-slate-600'>
        <p className='mt-2 mb-2 text-center text-yellow-500'> Marco </p>
